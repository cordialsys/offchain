...
func (c *Client) GetSubDepositAddress(accountId string, coin oc.SymbolId, network oc.NetworkId) (*GetDepositAddressResponse, error) {
	params := url.Values{}
	params.Set("coin", string(coin))
	params.Set("chainType", string(network))
	params.Set("subMemberId	", accountId)
